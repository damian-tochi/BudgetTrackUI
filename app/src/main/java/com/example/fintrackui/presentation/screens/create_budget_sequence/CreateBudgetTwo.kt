...
@Composable
fun CreateBudgetTwo(navController: NavHostController) {
    ...
    Column(
        ...
        RoundedButton("Next", onClicked = {
            navController.navigate(Screen.CreateBudgetThird.route)
...
@Composable
fun BudgetSourceSpinner() {
    var expanded by remember { mutableStateOf(false) }
    var selectedOption by remember { mutableStateOf("Select an option") }


    val items = listOf("Kuda", "Kuda")
