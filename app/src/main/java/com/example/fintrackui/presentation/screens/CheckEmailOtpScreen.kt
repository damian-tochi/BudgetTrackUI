...
@Composable
fun CheckEmailOtpScreen(navController: NavController) {
...
fun CheckEmailOtpContent() {
    ...
    Column (modifier = Modifier
        ...
        Text(
            text = "Please enter the one time passcode(OTP)\nbelow to continue with your account.",
            style = MaterialTheme.typography.caption,
            color = Color(0xff333741),
            fontWeight = FontWeight.Medium,
            fontSize = 12.sp,
        ...
        Text(
            text = "Enter one time passcode(OTP)",
            style = MaterialTheme.typography.caption,
...
@Preview
@Composable
fun CheckEmailOtpContentPreview() {
    CheckEmailOtpContent()
}